...
class rdklibEvaluationTest(unittest.TestCase):
    ...
    def test_evaluation_init(self):
        ...
        # Assigning value
        evaluation = CODE.Evaluation(CODE.ComplianceType.COMPLIANT, 'some-resource-id', 'some-resource-type', 'some-annotation')
        self.assertEqual(evaluation.complianceType, CODE.ComplianceType.COMPLIANT)
    ...
    def test_evaluation_eq(self):
        ...
        self.assertFalse(evaluation.__eq__(CODE.Evaluation(CODE.ComplianceType.NON_COMPLIANT, 'some-resource-id', 'some-resource-type', 'some-annotation')))
        self.assertFalse(evaluation.__eq__(CODE.Evaluation(CODE.ComplianceType.COMPLIANT, 'some-resource-id-2', 'some-resource-type', 'some-annotation')))
        self.assertFalse(evaluation.__eq__(CODE.Evaluation(CODE.ComplianceType.COMPLIANT, 'some-resource-id', 'some-resource-type-2', 'some-annotation')))
        self.assertFalse(evaluation.__eq__(CODE.Evaluation(CODE.ComplianceType.COMPLIANT, 'some-resource-id', 'some-resource-type')))
