...
class rdklibtestTest(unittest.TestCase):
    ...
    def test_assert_successful_evaluation(self):
        ...
        response_two = [Evaluation(ComplianceType.NON_COMPLIANT, 'some-resource-id', 'some-resource-type', 'some-annotation')]
    ...
    def test_assert_customer_error_response(self):
        error_message_no_code = {
            'internalErrorMessage': 'some-internal-error-msg', 'internalErrorDetails': 'some-internal-error-details',
            'customerErrorCode': ''
        }
        ...
        error_message_detail_empty = {
            'internalErrorMessage': 'some-internal-error-msg', 'internalErrorDetails': '',
            'customerErrorMessage': 'some-external-error-msg',
            'customerErrorCode': 'some-external-error-code'
        }
        with self.assertRaises(AssertionError) as context:
    ...
    def test_create_test_configurationchange_event(self):
        ...
        self.assertDictEqual(CODE.create_test_configurationchange_event(invoking_event, parameter), expected_event_param)
